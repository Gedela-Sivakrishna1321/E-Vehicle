...
const Spares = () => {
  ...
  useEffect(() => {
    ...
    const cachedSparesData = sessionStorage.getItem('sparesData');
    const cachedSpareBannerImage = sessionStorage.getItem('spareBannerImage');
  ...
  // Fetch spare parts data and store in sessionStorage
  async function fetchSparesData() {
    try {
      ...
      sessionStorage.setItem('sparesData', JSON.stringify(data)); // Cache data in sessionStorage
      setSparesData(data);
    } catch (error) {
  ...
  // Fetch spare banner image data and store in sessionStorage
  async function fetchSpareBannerData() {
    try {
      ...
      sessionStorage.setItem('spareBannerImage', JSON.stringify(imageArray)); // Cache data in sessionStorage
